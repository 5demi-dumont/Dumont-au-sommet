...
\chapter{Réduction géométrique}
	...
	\section{Caractérisation des matrices nilpotente par la trace \telecom{3}}
...
\begin{enumerate}[leftmargin=*]
	...
	\item Montrer que $a^{\frac{p-1}{2}}\in \{-\overline 1,\overline 1\}$.
...
\subsection{Formule de Chu-Vandermonde}
Pour $\alpha\in\R$, on pose $$\forall n\in\N, \binom{\alpha}{n}=\frac{\alpha(\alpha-1)\dots(\alpha-n+1)}{n!}$$
Etablir que : $$\forall (a,b)\in\R ,\sum_{k=0}^n\binom{a}{k}\binom{b}{n-k}=\binom{a+b}{n}$$
...
\begin{enumerate}
	...
	\item Soit $M\in\M_n(\K)$ est semblable à une matrice de la forme $\begin{pmatrix}
		N&0\\0&P
	\end{pmatrix}$ où $N$ est une matrice nilpotente et $C$ est une matrice carrée inversible.
\end{enumerate}
...
\section{Correction Réduction géométrique}
	...
	\subsection{Caractérisation des matrices nilpotente par la trace}
...
\section{Correction Dénombrement}
	...
	\subsubsection{Formule de Chu-Vandermonde}
