...
\chapter{Réduction géométrique}
	...
	\subsection{Dimension du commutant d'une matrice de rang 1}
...
\textcolor{blue}{\hyperref[Dimension de R en tant que Q espace vectoriel ]{[Enoncé]}}\\
	...
	\subsection{Caractérisation des homothéties (1)}
...
\section{Correction Réduction géométrique}
	...
	\subsubsection{Dimension du commutant d'une matrice de rang 1}
	...
	\underline{Si $\Tr(A)=0$ :}\\
	Par le même changement de base on se ramène à déterminer la dimension du commutant de $M=$
