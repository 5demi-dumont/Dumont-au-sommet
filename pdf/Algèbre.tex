...
\begin{enumerate}
	...
	\item Soit $B\in\mathcal{A}_n(\R)$. Montrer que $\forall x\in\R,\quad\exp(xB)\in\O_n(\R)$.
...
\section{Correction Déterminant}
	...
	\begin{enumerate}[leftmargin=*]
		...
		L'équation caractéristique de la relation est $r^2-ar+bc=0$ de solutions $r_1=\dfrac{a+\delta}{2}$ et $r_2=\dfrac{a-\delta}{2}$ avec $\delta^2=a^2-4bc$. Il faut maintenant distinguer deux cas :
		\begin{itemize}
...
\section{Correction Groupes}
	...
	Commençons par des exemples.\begin{itemize}
	...
	\begin{enumerate}[leftmargin=*]
		...
		On remarque que $\forall i\in \crblanc{1}{m-1},\ G_i\subsetneq G_{i+1}$. En effet, si pour un certain $i_0\in \crblanc{1}{m-1},\ G_{i_0}=G_{i_0+1}$ alors $\{a_1,\dots,a_{i_0},a_{i_0+2},\dots,a_m\}$ est une partie génératrice de $G$ ayant strictement moins d'éléments que $E$ ce qui est absurde.\\
	...
	\end{enumerate}
	\subsection{Partie génératrice de $\O(E)$}
